...
const EditUserPage = () => {
  ...
  /* PREFILL USER DATA (API CALL SIMULATION) */
  useEffect(() => {
    const existingUser = {
      fullName: "John Doe",
  ...
  const handleSubmit = (e) => {
    ...
    if (!payload.password) delete payload.password; // password optional
        ...
        <Container fluid>
          ...
          <div className="highlight-notes mt-3">
            <div className="highlight-notes-box">
              ...
              <h6 className="highlight-title">Important</h6>
              <p className="highlight-text">
                Changing role or admin access will affect user permissions immediately.
              </p>
            </div>
          </div>
